...
EOM;
	...
	public function index($indexPlatform = null, $package = null, $maxTime = 1800, $printCachesize = false, $quick = false) {
		if ($indexPlatform) {
			...
			if ($package) {
				...
				return $indexPlatform->index($package, $quick);
			}
		}
		...
		$this->indexPackages($packages, $quick, $endTime);
	...
	public function indexPackages(array $packages, $quick = false, $endTime = null) {
		$cnt = 0;
